...
class Barang extends BaseControllerApi
{
    ...
    public function index()
    {
        ...
        if ($where == "") {
            $data = $this->model->getBarang($page, $limit);
        } else {
            $data = $this->model->getBarang($page, $limit, $where);
        }
        if (!empty($data)) {
            $response = [
                "status" => true,
    ...
    public function getBarangKasir()
    {
        ...
        $page = $input['page'];
        $limit = $input['limit'];
        $data = $this->model->getBarangKasir($page, $limit);
        if (!empty($data)) {
            $response = [
                "status" => true,
                "message" => lang('App.getSuccess'),
    ...
    public function barangHabis()
    {
        ...
        $where = $input['kategori'] ?? "";
        if ($where == "") {
            $data = $this->model->getBarangHabis($page, $limit);
        } else {
            $data = $this->model->getBarangHabis($page, $limit, $where);
        }
        if (!empty($data)) {
            $response = [
                "status" => true,
    ...
    public function barangNonaktif()
    {
        ...
        $where = $input['kategori'] ?? "";
        if ($where == "") {
            $data = $this->model->getBarangNonaktif($page, $limit);
        } else {
            $data = $this->model->getBarangNonaktif($page, $limit, $where);
        }
        if (!empty($data)) {
            $response = [
                "status" => true,
