        ...
        <v-card-text>
            <v-form ref="form" v-model="valid">
                ...
                <v-row class="mt-n4">
                    ...
                    <v-col cols="12" md="9">
                        <v-select v-model="satuanBarang" label="<?= lang('App.selectUnit'); ?>" :items="dataSatuan" item-text="nama_satuan" item-value="nama_satuan" :error-messages="satuan_barangError" :loading="loading2" outlined dense append-outer-icon="mdi-plus-thick" @click:append-outer="addSatuan"></v-select>
                    </v-col>
                </v-row>
                ...
                <v-row class="mt-0">
                    ...
                    <v-col cols="12" md="9">
                        <v-autocomplete v-model="idKontak" label="Pilih Kontak" :items="dataVendor" :item-text="dataVendor =>`${dataVendor.nama} - ${dataVendor.perusahaan} - ${dataVendor.telepon}`" item-value="id_kontak" prepend-inner-icon="mdi-account" :error-messages="id_kontakError" :loading="loading3" outlined dense></v-autocomplete>
                    </v-col>
                </v-row>
