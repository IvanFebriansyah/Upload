        ...
        <v-card-text>
            <v-form ref="form" v-model="valid">
                ...
                <v-row class="mt-n4">
                    ...
                    <v-col cols="12" md="9">
                        <v-select v-model="satuanBarang" :items="dataSatuan" item-text="nama_satuan" item-value="nama_satuan" :error-messages="satuan_barangError" :loading="loading2" outlined dense append-outer-icon="mdi-plus-thick" @click:append-outer="addSatuan"></v-select>
                    </v-col>
                </v-row>
