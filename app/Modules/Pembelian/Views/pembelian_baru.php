    ...
    <v-card>
        ...
        <v-card-text>
            <v-form ref="form" v-model="valid">
                ...
                <v-autocomplete v-model="idKontak" label="Pilih Kontak" :items="dataVendor" :item-text="dataVendor =>`${dataVendor.nama} - ${dataVendor.perusahaan} - ${dataVendor.telepon}`" item-value="id_kontak" prepend-inner-icon="mdi-account" :error-messages="id_kontakError" :loading="loading3" outlined></v-autocomplete>
