                    ...
                    <v-row>
                        ...
                        <v-col cols="12" sm="5" md="5">
                            <?php if ($scanKeranjang == '0') { ?>
                                <v-text-field v-model="pencarian" prepend-inner-icon="mdi-magnify" label="" placeholder="<?= lang('App.searchItem') ?>/Code Item/Barcode/SKU" class="mb-1" solo dense single-line hide-details clearable autofocus :autofocus="'autofocus'"></v-text-field>
                            <?php } else { ?>
                                <v-text-field v-model="pencarian" prepend-inner-icon="mdi-magnify" label="" placeholder="<?= lang('App.searchItem') ?>/Code Item/Barcode/SKU" class="mb-1" solo dense single-line hide-details clearable></v-text-field>
                            <?php } ?>
                                    ...
                                    <tr>
                                        <td>
                                            <v-list-item class="ma-n5 pa-n5" two-line>
                                                ...
                                                <v-list-item-content>
                                                    <p class="text-body-2">{{item.nama_barang}} | <?= lang('App.stock'); ?>: {{item.stok}}</p><br />
                                        ...
                                        <td width="30%" class="text-caption">{{item.kode_barang}}<br /><v-icon>mdi-barcode</v-icon> {{item.barcode}}<br />SKU {{item.sku ?? "-"}}</td>
                                        <td align="center">
            ...
            <v-card class="pa-2">
                ...
                <v-card-actions>
                    ...
                    <v-menu offset-y>
                        <template v-slot:activator="{ on, attrs }">
                            <v-btn large text v-bind="attrs" v-on="on">
                                <v-icon>mdi-printer-outline</v-icon> <?= lang('App.print') ?> (in-Browser)
                            </v-btn>
                        </template>
                        <v-list>
                            <v-list-item link :href="'<?= base_url('penjualan/printnota-html') ?>' + '?id_penjualan=' + idPenjualan" target="_blank">
                                <v-list-item-title>
                                    <v-icon>mdi-printer-pos</v-icon> Thermal
                                </v-list-item-title>
                            </v-list-item>
                            <v-list-item link :href="'<?= base_url('penjualan/printnota-html-a4') ?>' + '?id_penjualan=' + idPenjualan" target="_blank">
                                <v-list-item-title>
