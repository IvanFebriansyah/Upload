...
<!-- Form Pencarian -->
<template>
    <v-container class="indigo lighten-5" fluid>
        <div class="pt-7">
    ...
    <v-container class="mt-3" v-show="result == true">
        <!-- Tampil Hasil Pencarian -->
        <h2 class="text-h5 font-weight-medium mb-4" v-show="result == true"><?= lang('App.searchResult'); ?> "{{pencarian}}" &nbsp;<v-btn text @click="clear" title="Clear" alt="Clear"><v-icon color="error">mdi-eraser</v-icon> Clear</v-btn></h2>
