...
<head>
    ...
    <title><?= APP_NAME ?> - Aplikasi Kasir Warung dari <?= COMPANY_NAME . ', ' . COMPANY_ADDRESS ?></title>
    ...
    <div id="app">
        ...
        <v-app>
            ...
            <v-app-bar app color="<?= $navbarColor; ?>" <?= ($navbarColor == 'white' ? 'light':'dark'); ?> elevation="1">
                <v-toolbar-title class="text-h5 font-weight-medium" style="cursor: pointer;"><a href="<?= base_url() ?>" class="text-decoration-none white--text" title="" alt=""><?= APP_NAME ?></a></v-toolbar-title>
                <v-spacer></v-spacer>
