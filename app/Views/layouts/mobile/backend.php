...
<head>
    ...
    <meta name="description" content="<?= APP_NAME ?> Aplikasi Kasir Warung dibuat Oleh <?= COMPANY_NAME . ', ' . COMPANY_ADDRESS ?>">
        ...
        <v-app>
                ...
                <v-list>
                    ...
                    <v-list-item-group>
                        ...
                        <?php if (session()->get('role') == 1 || session()->get('role') == 3) : ?>
                            ...
                            <v-list-group color="white" prepend-icon="mdi-swap-horizontal-bold" <?php if ($uri->getSegment(1) == "penjualan" || $uri->getSegment(1) == "pembelian"  || $uri->getSegment(1) == "hutang" || $uri->getSegment(1) == "piutang" || $uri->getSegment(1) == "biaya") : ?><?= 'value="true"'; ?><?php endif; ?> title="<?= lang('App.transaction') ?>" alt="<?= lang('App.transaction') ?>">
                                <template v-slot:activator>
                                    <v-list-item-content>
                            ...
                            <v-list-group color="white" prepend-icon="mdi-store-cog" <?php if ($uri->getSegment(1) == "settings" || $uri->getSegment(1) == "user" || $uri->getSegment(1) == "toko" || $uri->getSegment(1) == "backup") : ?><?= 'value="true"'; ?><?php endif; ?> title="<?= lang('App.settings') ?>" alt="<?= lang('App.settings') ?>">
                                <template v-slot:activator>
                                    <v-list-item-content>
                        ...
                        <?php if (session()->get('role') == 2) : ?>
                            ...
                            <v-list-item link href="<?= base_url('sales'); ?>" <?php if ($uri->getSegment(1) == "sales") : ?><?= 'class="v-item--active v-list-item--active"'; ?><?php endif; ?> title="Point of Sales" alt="Point of Sales">
                                <v-list-item-icon>
                                    <v-icon>mdi-cash-register</v-icon>
                                </v-list-item-icon>
                                <v-list-item-content>
                            ...
                            <v-list-group color="white" prepend-icon="mdi-swap-horizontal-bold" <?php if ($uri->getSegment(1) == "penjualan" || $uri->getSegment(1) == "piutang" || $uri->getSegment(1) == "biaya") : ?><?= 'value="true"'; ?><?php endif; ?> title="<?= lang('App.transaction') ?>" alt="<?= lang('App.transaction') ?>">
                                <template v-slot:activator>
                                    <v-list-item-content>
                                        <v-list-item-title><?= lang('App.transaction'); ?></v-list-item-title>
                                    </v-list-item-content>
                            ...
                            <v-list-group color="white" prepend-icon="mdi-cash" <?php if ($uri->getSegment(1) == "cashflow" || $uri->getSegment(1) == "pajak") : ?><?= 'value="true"'; ?><?php endif; ?> title="<?= lang('App.finance') ?>" alt="<?= lang('App.finance') ?>">
                                <template v-slot:activator>
                                    <v-list-item-content>
                                        <v-list-item-title><?= lang('App.finance'); ?></v-list-item-title>
                                    </v-list-item-content>
                                ...
                                <v-list-item link href="<?= base_url('cashflow'); ?>" <?php if ($uri->getSegment(1) == "cashflow") : ?><?= 'class="v-item--active v-list-item--active"'; ?><?php endif; ?> title="<?= lang('App.cash'); ?>" alt="<?= lang('App.cash'); ?>">
                                    <v-list-item-icon>
                                        <v-icon>mdi-file-document</v-icon>
                                    </v-list-item-icon>
                                    <v-list-item-content>
                                        <v-list-item-title><?= lang('App.cash'); ?></v-list-item-title>
                                    </v-list-item-content>
                                </v-list-item>
                        ...
                        <?php if (session()->get('role') == 5) : ?>
                            ...
                            <v-list-item link href="<?= base_url('barang'); ?>" <?php if ($uri->getSegment(1) == "barang") : ?><?= 'class="v-item--active v-list-item--active"'; ?><?php endif; ?> title="<?= lang('App.items') ?>" alt="<?= lang('App.items') ?>">
                                <v-list-item-icon>
                                    <v-icon>mdi-package-variant</v-icon>
                                </v-list-item-icon>
                                <v-list-item-content>
            ...
            <v-container class="mb-10">
                <p class="text-center text-caption mb-3">
                    &copy; 2020-{{ new Date().getFullYear() }} <?= COMPANY_NAME . ', ' . COMPANY_ADDRESS ?>. Software <?= APP_NAME  . ' ' . APP_VERSION ?>. All rights reserved
                </p>
            </v-container>
